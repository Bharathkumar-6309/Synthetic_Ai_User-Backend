...
class Settings(BaseSettings):
    ...
    # --- LLM / AI Gateway ---
    # Primary model provider. If GEMINI_API_KEY is not set, the persona agent
    # automatically falls back to Ollama (if OLLAMA_BASE_URL reachable), and if
    # neither is available, to a deterministic Faker-based synthetic generator
    # so the API remains fully testable offline.
